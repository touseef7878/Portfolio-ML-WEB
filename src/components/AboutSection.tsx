      ...
      >
        ...
        <div className="glass rounded-3xl p-10 md:p-14 max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center relative group hover:border-primary/20 transition-all duration-500">
          ...
          <div className="relative shrink-0">
            <div className="absolute -inset-2 bg-gradient-to-br from-primary/30 to-accent/30 rounded-2xl blur-lg opacity-60 group-hover:opacity-80 transition-opacity duration-500" />
             <img
               src={profilePhoto}
               alt="Touseef Ur Rehman"
               loading="lazy"
               className="relative w-48 h-48 md:w-56 md:h-56 rounded-2xl object-cover border-2 border-white/10 shadow-2xl"
             />
          </div>
